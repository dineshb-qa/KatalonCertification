...
'Verify user can toggle i.e. collapse/expand the left menu'
LeftMenu leftMenu = new LeftMenu()
leftMenu.verifyUserCanToggleLeftMenu()
WebUI.comment('Verified that user can toggle i.e. collapse/expand the left menu')