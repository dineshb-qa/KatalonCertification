...
'Verify Orange HRM Logo is present on left menu'
LeftMenu leftMenu = new LeftMenu()
assert leftMenu.isOrangeHRMLogoPresent() == true
WebUI.comment('Verified that Orange HRM logo is present on left menu')