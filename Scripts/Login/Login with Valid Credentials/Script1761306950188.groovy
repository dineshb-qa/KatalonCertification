...
'Verify user profile dropdown is visible after login'
assert common.isUserProfileDropdownDisplayed() == true
WebUI.comment('Verified that, user logged in successfully!!!')