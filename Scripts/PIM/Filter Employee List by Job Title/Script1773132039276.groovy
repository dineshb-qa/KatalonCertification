...
'Search Employee List by Job Title'
pimPage.selectJobTitleFromDropdown('HR Manager')

'Verify Employee List filered by "HR Manager" Job Title'
pimPage.verifyEmployeeListFilteredByJobTitle("HR Manager")
WebUI.comment('Verified that, in the search results, the \"Job Title\" column value for each user is \"HR Manager\"')