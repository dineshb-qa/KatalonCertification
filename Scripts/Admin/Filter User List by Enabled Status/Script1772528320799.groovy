...
'Search System Users by Enabled status'
adminPage.searchUsersByStatus("Enabled")

'Verify System Users filered by Enabled status'
adminPage.verifyUsersFilteredByEnabledStatus("Enabled")
WebUI.comment('Verified that, in the search results, the \"Status\" column value for each user is \"Enabled\"')