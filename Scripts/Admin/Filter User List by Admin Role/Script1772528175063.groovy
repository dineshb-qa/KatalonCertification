...
'Search System Users by Admin role'
adminPage.searchUsersByUserByRole("Admin")

'Verify System Users filered by Admin role'
adminPage.verifyUsersFilteredByAdminRole("Admin")
WebUI.comment('Verified that, in the search results, the \"User Role\" column value for each user is \"Admin\"')